package com.lpf.common.page.plugin;


import com.lpf.common.page.plugin.dialect.Dialect;
import com.lpf.common.page.plugin.domain.PageBounds;
import com.lpf.common.page.plugin.domain.PageList;
import com.lpf.common.page.plugin.domain.Paginator;
import com.lpf.common.page.plugin.support.PropertiesHelper;
import com.lpf.common.page.plugin.support.SQLHelp;
...
public class OffsetLimitInterceptor implements Interceptor{
	...
	public void setProperties(Properties properties) {
        ...
        setPoolMaxSize(propertiesHelper.getInt("poolMaxSize",0));// 默认是为0，可以在xml中配置
